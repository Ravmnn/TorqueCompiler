...
public class DebugTypeMetadataGenerator(IRGenerator compiler, LLVMDIBuilderRef debugBuilder, LLVMMetadataRef file, LLVMMetadataRef compileUnit)
{
    private readonly Dictionary<string, LLVMMetadataRef> _structCache = [];


    public IRGenerator Compiler { get; } = compiler;
    ...
    public DebugTypeMetadataGenerator(DebugMetadataGenerator generator, DebugTypeMetadataGenerator typeGenerator, IRGenerator compiler)
